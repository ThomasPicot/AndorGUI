...
################################################################################
## Form generated from reading UI file 'MainWindowecJmYm.ui'
##
...
"}")
        ...
        self.pushButton_ROI = QPushButton(self.centralwidget)
        self.pushButton_ROI.setObjectName(u"pushButton_ROI")

        self.gridLayout.addWidget(self.pushButton_ROI, 3, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_ROI.setText(QCoreApplication.translate("MainWindow", u"Camera ROI", None))
    # retranslateUi
