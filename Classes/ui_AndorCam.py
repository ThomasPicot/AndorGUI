...
################################################################################
## Form generated from reading UI file 'MainWindowHFWmGe.ui'
##
...
"")
        ...
        self.gridLayout.addWidget(self.pushButton_shot, 2, 1, 1, 1)
...
"")
        ...
        sizePolicy3.setHeightForWidth(self.pushButtonArm.sizePolicy().hasHeightForWidth())
        self.pushButtonArm.setSizePolicy(sizePolicy3)
...
"")
        ...
        sizePolicy4.setHeightForWidth(self.pushButton_disarm.sizePolicy().hasHeightForWidth())
        self.pushButton_disarm.setSizePolicy(sizePolicy4)
...
"")
        ...
        self.gridLayout.addWidget(self.pushButton_normalisation, 3, 1, 1, 1)
...
"")
        ...
        sizePolicy5.setHeightForWidth(self.widgetBinningFrame.sizePolicy().hasHeightForWidth())
        self.widgetBinningFrame.setSizePolicy(sizePolicy5)
        ...
        sizePolicy6.setHeightForWidth(self.textBrowserLogs.sizePolicy().hasHeightForWidth())
        self.textBrowserLogs.setSizePolicy(sizePolicy6)
